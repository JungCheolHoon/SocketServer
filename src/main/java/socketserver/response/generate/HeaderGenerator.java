package socketserver.response.generate;
...
public class HeaderGenerator {
    ...
    public HeaderGenerator(String uri) {
        ...
        this.file = uri.equals("/favicon.ico")?new File(ClientHandler.PROJECT_DIRECTORY +"/resources" + uri) : new File(ClientHandler.PROJECT_DIRECTORY +"/resources/templates" + uri + ".html");
    }
